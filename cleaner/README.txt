...
HOW TO USE
Put the images you want to process in the folder you unzipped the executable into. Then run the executable.

Note that the program will crash if it does´t find the "results" folder.
